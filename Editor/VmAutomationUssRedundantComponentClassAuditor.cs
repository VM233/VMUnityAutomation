...
{
    internal static class VmAutomationUssRedundantComponentClassAuditor
    {
            ...
            bool includeSuppressed)
        {
            foreach (var token in EnumerateClassTokens(rules))
            {
                ...
                if (HasPlacementContract(rules, token) ||
                    VmAutomationUssGeneratedChildStyleOwnershipAuditor
                ...
                VmAutomationUssStyleAuditor.AddIssue(report, selectorOwner.Rule,
        ...
        internal static IReadOnlyList<Dictionary<string, object>> RunSelfTests()
        {
            ...
            var rules = VmAutomationUssStyleSheetParser.ParseStyleSheet(path,
            ...
            var placementRules = VmAutomationUssStyleSheetParser.ParseStyleSheet(path,
            ...
            var skinRules = VmAutomationUssStyleSheetParser.ParseStyleSheet(path,
