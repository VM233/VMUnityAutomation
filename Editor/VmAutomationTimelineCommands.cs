...
{
    internal static class VmAutomationTimelineCommands
    {
        ...
        public static object Transaction(Dictionary<string, object> args)
        {
            ...
            Undo.SetCurrentGroupName("VM Unity Automation Edit Timeline");
            Undo.RegisterCompleteObjectUndo(
                AssetDatabase.LoadAllAssetsAtPath(AssetDatabase.GetAssetPath(timeline)),
                "VM Unity Automation Edit Timeline");
            ...
            Type timelineType, Dictionary<string, object> operation)
        {
            ...
            if (action == "create-track")
            {
                Type trackType = FindAssignableType(GetString(operation, "trackType"),
                    VmAutomationAssetGraphUtility.FindType(TrackAssetTypeName));
                if (trackType == null)
        ...
        {
            Type clipType = VmAutomationAssetGraphUtility.FindType(TimelineClipTypeName);
            if (clipType == null)
            ...
            Type timelineType, Dictionary<string, object> operation)
        {
            ...
            if (action == "create-track")
            {
                ...
                MethodInfo createTrack = timelineType.GetMethod("CreateTrack",
                    ...
                    new[]
                    {
                        typeof(Type), VmAutomationAssetGraphUtility.FindType(TrackAssetTypeName),
                        typeof(string)
                    }, null);
                if (createTrack == null)
            ...
            if (action == "set-track-property")
            {
                ...
                return new Dictionary<string, object>
                {
                    ...
                    { "before", before },
                    { "after", VmAutomationComponentCommands.GetSerializedValue(
        ...
        private static void ApplyClipValues(object clip, Dictionary<string, object> operation)
        {
            ...
            Type clipType = VmAutomationAssetGraphUtility.FindType(TimelineClipTypeName) ?? clip.GetType();
        ...
        {
            timeline = null;
            timelineType = VmAutomationAssetGraphUtility.FindType(TimelineAssetTypeName);
            ...
            {
                error = VmAutomationResponse.Error("assetPath is required.", "invalid_arguments");
                return false;
            }
