...
namespace VMUnityAutomation.Editor
{
    ...
    public static class MCPPackageManagerCommands
    {
        ...
        {
            return MCPWorkspaceJobRunner.StartGitPackageUpdate(args);
        }

        public static object ResolvePackages(Dictionary<string, object> args)
        {
            return MCPWorkspaceJobRunner.StartPackageResolve(args);
        }
        ...
        internal static bool TryBuildExpectedGitPackages(Dictionary<string, object> args,
            out List<MCPGitPackageExpectation> expectations, out string error)
        {
            expectations = new List<MCPGitPackageExpectation>();
            error = "";
            ...
            {
                Dictionary<string, object> item = MCPResponse.ToDictionary(value);
                ...
                expectations.Add(new MCPGitPackageExpectation(name, identifier, revision));
            }
        ...
        internal static Dictionary<string, object> BuildGitPackageResolutionState(
            MCPGitPackageExpectation expectation)
        {
