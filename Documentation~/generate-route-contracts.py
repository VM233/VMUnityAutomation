...
OUTPUT_PROPERTY_OVERRIDES: dict[tuple[str, str], dict[str, object]] = {
    ...
    ("scriptableobject/info", "properties"): exact_array(exact_object({
        "name": STRING,
        "displayName": STRING,
        "type": STRING,
        "value": JSON_VALUE,
        ...
        "depth": INTEGER,
    }, ("name", "displayName", "type", "value", "isArray", "depth"))),
    ("scriptableobject/set-field", "value"): JSON_VALUE,
    ("sceneview/info", "size"): NUMBER,
    ("selection/focus-scene-view", "size"): NUMBER,
    ("serialized-object/get", "property"): SERIALIZED_PROPERTY_INFO,
    ("serialized-object/get", "properties"): exact_array(SERIALIZED_PROPERTY_INFO),
...
TRANSACTION_COMPILATION_EVIDENCE = exact_object({
    ...
    "startedCompilationAssemblyCount": INTEGER,
    "finishedCompilationAssemblyCount": INTEGER,
    "notRequiredCompilationAssemblyCount": INTEGER,
    "terminalCompilationAssemblyCount": INTEGER,
    "expectedCompilationAssemblies": STRING_ARRAY,
    "startedCompilationAssemblies": STRING_ARRAY,
    "finishedCompilationAssemblies": STRING_ARRAY,
    "notRequiredCompilationAssemblies": STRING_ARRAY,
    "terminalCompilationAssemblies": STRING_ARRAY,
    "assembliesWithoutStartedCallback": STRING_ARRAY,
    "missingTerminalCompilationAssemblies": STRING_ARRAY,
    "cleanBuildCacheCallbackLimitationObserved": BOOLEAN,
})
...
OUTPUT_SCHEMA_OVERRIDES: dict[str, list[dict[str, object]]] = {
    ...
    "screenshot/editor-window": [exact_object({
        ...
        "captureMethod", "targetWindowVerified", "coordinateMode", "captureGeometry", "contentRect", "centerColorRange",
