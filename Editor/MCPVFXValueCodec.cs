...
{
    internal static class MCPVFXValueCodec
    {
            ...
            Type targetType, string valuePath)
        {
            ...
            assetPath = MCPVFXAssetPath.RequireFile(assetPath, true,
                valuePath + ".assetPath");
            ...
            if (dictionary.TryGetValue("type", out object rawType))
            {
                ...
                Type declaredType = MCPAssetGraphUtility.FindType(typeName);
            ...
            string valuePath)
        {
            ...
            return MCPAssetGraphUtility.FindType(fullTypeName) ??
                   throw new ArgumentException(
