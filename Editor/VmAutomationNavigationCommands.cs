...
namespace VMUnityAutomation.Editor
{
    ...
    /// </summary>
    public static class VmAutomationNavigationCommands
    {
        // ─── Bake NavMesh ───
        ...
        public static object GetNavMeshInfo(Dictionary<string, object> args)
        {
            ...
            int agentCount = 0;
            int obstacleCount = 0;
            var agents = VmAutomationObjectSearch.Find<NavMeshAgent>(includeInactive: true);
            var obstacles = VmAutomationObjectSearch.Find<NavMeshObstacle>(includeInactive: true);
