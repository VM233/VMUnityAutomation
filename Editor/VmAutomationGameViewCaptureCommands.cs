...
namespace VMUnityAutomation.Editor
{
    ...
    /// </summary>
    public static class VmAutomationGameViewCaptureCommands
    {
            ...
            Action<object> resolve)
        {
            ...
            if (VmAutomationRuntimePreconditions.TryRequirePlayMode(
                    "screenshot/game",
            ...
            {
                path = VmAutomationSettings.CreateDefaultScreenshotPath("GameView");
            }
            ...
            if (EditorApplication.isPaused)
            {
                ...
                {
                    pausedResult = VmAutomationResponse.Error(
                ...
                try
                {
                    ...
                    if (File.Exists(fullPath))
                    {
                        ...
                        if (stableFileFrames >= stableFrames &&
                            VmAutomationScreenshotCommands.TryReadPngInfo(
            ...
            string path, int superSize = 1)
        {
                    ...
                    out object presentationError) == false)
            {
                return presentationError as Dictionary<string, object> ??
                       VmAutomationResponse.Error(presentationError?.ToString() ??
            ...
            bool flipVertically)
        {
            ...
            try
            {
                ...
                if (VmAutomationScreenshotCommands.TryReadPngInfo(
            ...
            string path, string fullPath, int superSize)
        {
            ...
            gameView.Repaint();
            VmAutomationScreenshotCommands.RepaintImmediately(gameView);
