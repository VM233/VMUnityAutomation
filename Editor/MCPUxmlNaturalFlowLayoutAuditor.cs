...
{
    internal static class MCPUxmlNaturalFlowLayoutAuditor
    {
        ...
        private static void RecordFixedNaturalCrossSizeIssue(string assetPath,
            ...
            int inFlowChildCount, MCPUxmlLayoutAuditReport report,
        ...
        private static void RecordIssue(string assetPath, XElement parent,
            ...
            string axis, MCPUxmlLayoutAuditReport report, bool includeSuppressed)
        {
        ...
        private static MCPUxmlLayoutAuditReport AuditSelfTestFixture(string element,
            bool includeSuppressed)
        {
