...
using static VMUnityAutomation.Editor.VmAutomationUssStyleAuditor;
...
namespace VMUnityAutomation.Editor
{
    internal static class VmAutomationUssCascadeAuditor
    {
        ...
        {
            assetPath = VmAutomationUIToolkitAuditUtility.NormalizeAssetPath(assetPath);
            ...
            try
            {
                var fullPath = VmAutomationUIToolkitAuditUtility.ToFullPath(assetPath);
        ...
        private static void AddRedundantDeclarationIssue(VmAutomationUssStyleAuditReport report,
