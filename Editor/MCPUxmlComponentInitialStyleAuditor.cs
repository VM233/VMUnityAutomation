...
{
    internal static class MCPUxmlComponentInitialStyleAuditor
    {
            ...
            MCPUxmlLayoutAuditReport report, bool includeSuppressed)
        {
            foreach (var element in document.Descendants().Where(IsAuthoredVisualElement))
            {
                ...
                var identity = MCPUIToolkitElementStyleBaseline.Resolve(
        ...
        internal static IReadOnlyList<Dictionary<string, object>> RunSelfTests()
        {
            ...
            var suppressed = AuditFixture(
                $"<!-- {MCPUxmlLayoutAuditor.REDUNDANT_INLINE_SUPPRESSION_MARKER} " +
        ...
        private static void RecordIssue(string assetPath, XElement element,
            MCPUIToolkitElementStyleBaseline.ElementIdentity identity,
