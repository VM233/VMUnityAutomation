...
{
    internal sealed class VmAutomationProjectAuditorQuery
    {
        ...
        private VmAutomationProjectAuditorQuery(IssueCategory[] categories,
            ...
            out Dictionary<string, object> error)
        {
            ...
            query = new VmAutomationProjectAuditorQuery(categories, descriptorIds,
