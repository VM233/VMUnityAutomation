...
namespace VMUnityAutomation.Editor
{
    internal static class MCPResponse
    {
        ...
        private static object PreserveProjectToolSchemaShape(object value)
        {
            ...
            if (MCPUnityValueFormatter.TryStructureUnityValue(value, out object structuredValue))
    ...
    /// execute-code format or a typed JSON structure for normal MCP transport.
    /// </summary>
    internal static class MCPUnityValueFormatter
    {
