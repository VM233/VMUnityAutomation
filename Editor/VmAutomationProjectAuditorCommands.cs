...
{
    internal static class VmAutomationProjectAuditorCommands
    {
#if UNITY_6000_4_OR_NEWER
        ...
        {
#if UNITY_6000_4_OR_NEWER
            if (!VmAutomationCapabilityRegistry.IsCapabilityAvailable("project-auditor"))
            {
            ...
            if (!VmAutomationProjectAuditorQuery.TryCreate(categories, descriptorIds,
                    severities, offset, limit,
                    out VmAutomationProjectAuditorQuery query,
            ...
            analysisParams.OnCompleted = report =>
            {
                ...
                try
                {
                    result = VmAutomationProjectAuditorReportSerializer.Serialize(report,
