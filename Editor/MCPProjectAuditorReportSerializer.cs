...
{
    internal static class MCPProjectAuditorReportSerializer
    {
        internal static Dictionary<string, object> Serialize(Report report,
            MCPProjectAuditorQuery query, string platform, long elapsedMs)
        {
        ...
        internal static Dictionary<string, object> SerializeSnapshot(
            ...
            int totalIssueCount, MCPProjectAuditorQuery query, string platform,
            long elapsedMs)
        {
