...
{
    /// <summary>
    /// Isolates synchronous Automation mutations into request-owned Undo groups. A group is targetable
    /// only while its in-memory ownership token is current; reloads and intervening edits revoke it.
    /// </summary>
    [InitializeOnLoad]
    internal static class VmAutomationRequestUndoCoordinator
    {
        ...
        internal static void RegisterAction(VmAutomationActionRecord record, Ownership ownership)
        {
        ...
        internal static object PerformUndo(Dictionary<string, object> args)
        {
            ...
            if (Undo.GetCurrentGroup() != ownership.BoundaryGroup)
            {
                ...
                return VmAutomationResponse.Error(
                    "The Unity Undo group advanced after this Automation request; targeted undo would affect unrelated work.",
            ...
            VmAutomationActionHistory.NotifyRecordUpdated();
            ...
            out Ownership ownership, out object error)
        {
            ...
            error = VmAutomationResponse.Error(
                "The requested Automation Undo identity is unavailable in this Unity domain.",
                "undo_request_not_available", false);
            return false;
        }
        ...
        internal sealed class Ownership
        {
            ...
            internal VmAutomationActionRecord Record;
        }
    }
}
