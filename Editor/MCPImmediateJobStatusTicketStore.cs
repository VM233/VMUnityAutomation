...
namespace VMUnityAutomation.Editor
{
    ...
    /// </summary>
    internal static class MCPImmediateJobStatusTicketStore
    {
        ...
        {
            object result = MCPJobHistory.GetPublishedSnapshot(arguments);
        ...
        private sealed class Ticket
        {
                ...
                object result)
            {
                        ...
                        out string errorCode, out bool retryable))
                {
                    ...
                    ErrorCode = errorCode;
                    Retryable = retryable;
                    Result = MCPResponse.NormalizeError(result, errorCode, retryable);
                }
                else
                {
                    Status = "Completed";
