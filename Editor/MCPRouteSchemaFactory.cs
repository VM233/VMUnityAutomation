...
namespace VMUnityAutomation.Editor
{
    ...
    internal static class MCPRouteSchemaFactory
    {
        ...
        {
            return MCPToolSchemaFactory.WithJsonValueDefinition(schema);
        }
        ...
        internal static Dictionary<string, object> McpError()
        {
            return Object(new[]
            {
