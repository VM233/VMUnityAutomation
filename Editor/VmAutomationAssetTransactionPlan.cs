...
namespace VMUnityAutomation.Editor
{
    ...
    /// </summary>
    internal sealed class VmAutomationAssetTransactionPlan
    {
        ...
        internal static VmAutomationAssetTransactionPlan Build(Dictionary<string, object> args)
        {
            ...
            var plan = new VmAutomationAssetTransactionPlan();
            ...
            {
                VmAutomationResponse.TryGetError(sceneMutationError, out string message,
