...
{
    internal sealed class MCPGitPackageExpectation
    {
        internal MCPGitPackageExpectation(string name, string identifier, string revision)
        {
            Name = name;
        ...
        internal static MCPGitPackageExpectation FromDictionary(
            Dictionary<string, object> values)
        {
            ...
            return new MCPGitPackageExpectation(name, identifier, revision);
        }
