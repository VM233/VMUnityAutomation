...
{
    public static class VmAutomationComponentCommands
    {
        ...
        private static object SetSingleReference(Dictionary<string, object> args)
        {
            ...
            {
                // Find by instance ID
                targetRef = VmObjectId.ToObject(refInstanceId);
                if (targetRef == null)
            ...
            else if (!string.IsNullOrEmpty(gameObjectRef))
            {
                ...
                if (refGo == null)
                {
                    ...
                    var allObjects = VmAutomationObjectSearch.Find<GameObject>();
            ...
            Action<object> progress)
        {
            ...
            if (execution.ResolveMode(requests.Count) == VmAutomationExecutionMode.Immediate)
            {
        ...
        private static Dictionary<string, object> BuildReferenceResults(int requestCount,
            List<Dictionary<string, object>> results, VmAutomationExecutionOptions execution)
        {
        ...
        public static object GetReferenceableObjects(Dictionary<string, object> args)
        {
            ...
            {
                var found = VmAutomationObjectSearch.Find(expectedType);
                foreach (var obj in found)
                {
                    ...
                    sceneObjects.Add(new Dictionary<string, object>
                    {
                        ...
                        { "instanceId", VmObjectId.Get(comp) },
            ...
            {
                var found = VmAutomationObjectSearch.Find<GameObject>();
                foreach (var obj in found)
                {
                    sceneObjects.Add(new Dictionary<string, object>
                    {
                ...
                case SerializedPropertyType.ObjectReference:
                    if (prop.objectReferenceValue != null)
                    {
                        ...
                        var info = new Dictionary<string, object>
                        {
                            ...
                            { "instanceId", VmObjectId.Get(refObj) },
                        };
        ...
        private static void SetManagedReferenceValue(SerializedProperty prop, object value, Type fallbackType = null)
        {
            ...
            if (requestedType != null || currentValue == null || currentValue.GetType() != targetType)
            {
                object instance;
                try
                {
        ...
        internal static UnityEngine.Object ResolveObjectReference(object value)
        {
            ...
            if (dict != null)
            {
                ...
                {
                    resolved = VmObjectId.ToObject(dict["instanceId"]);
                }
