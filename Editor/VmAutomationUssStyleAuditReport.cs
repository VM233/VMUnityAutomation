...
{
    internal sealed class VmAutomationUssStyleAuditReport
    {
        ...
        public readonly List<VmAutomationUssStyleAuditIssue> Issues =
            new List<VmAutomationUssStyleAuditIssue>();
        ...
        public VmAutomationUssStyleAuditReport(int maxIssues)
        {
        ...
        public void Record(VmAutomationUssStyleAuditIssue issue, bool includeSuppressed)
        {
            if (issue.Suppressed)
            {
        ...
        public Dictionary<string, object> ToDictionary()
        {
            return new Dictionary<string, object>
            {
                ...
                { "suppressionSyntax",
                    $"/* {VmAutomationUssStyleAuditor.SUPPRESSION_MARKER} <reason> */" },
                { "redundantDeclarationSuppressionSyntax",
                    $"/* {VmAutomationUssStyleAuditor.REDUNDANT_DECLARATION_SUPPRESSION_MARKER} " +
                    "<reason> */" },
                { "ancestorDefaultResetSuppressionSyntax",
                    $"/* {VmAutomationUssStyleAuditor.ANCESTOR_DEFAULT_RESET_SUPPRESSION_MARKER} " +
                    "<reason> */" },
                { "pixelGridSuppressionSyntax",
                    $"/* {VmAutomationUssStyleAuditor.PIXEL_GRID_SUPPRESSION_MARKER} <reason> */" },
                { "textStyleContractSuppressionSyntax",
                    $"/* {VmAutomationUssStyleAuditor.TEXT_STYLE_CONTRACT_SUPPRESSION_MARKER} " +
                    "<reason> */" }
            };
        }
    }
