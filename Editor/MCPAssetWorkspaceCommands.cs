...
namespace VMUnityAutomation.Editor
{
    public static class MCPAssetWorkspaceCommands
    {
        ...
        {
            if (MCPAssetTransactionPlan.GetBool(args, "dryRun"))
                return MCPAssetTransactionJobRunner.DryRun(args);
            if (!MCPAssetTransactionJobRunner.TryValidateStart(args, out object error))
                return error;
            return MCPWorkspaceJobRunner.StartAssetTransaction(args);
        }
