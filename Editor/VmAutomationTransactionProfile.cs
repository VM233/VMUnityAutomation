...
namespace VMUnityAutomation.Editor
{
    ...
    /// </summary>
    internal sealed class VmAutomationTransactionProfile
    {
        ...
        internal static VmAutomationTransactionProfile Create(string scope, string atomicity,
            string isolation, string durability, string rollbackKind,
            params string[] commitEvidence)
        {
            var profile = new VmAutomationTransactionProfile
            {
                Scope = scope,
                Atomicity = atomicity,
                Isolation = isolation,
        ...
        internal VmAutomationTransactionProfile Clone()
        {
