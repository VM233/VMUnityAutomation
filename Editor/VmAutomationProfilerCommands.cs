...
namespace VMUnityAutomation.Editor
{
    ...
    /// and frame debugger event inspection via Automation.
    ///
    ...
    public static class VmAutomationProfilerCommands
    {
        ...
        public static object AnalyzePerformance(Dictionary<string, object> args)
        {
            ...
            // 4. Scene complexity
            var allRenderers = VmAutomationObjectSearch.Find<Renderer>();
            var allLights = VmAutomationObjectSearch.Find<Light>();
            int totalGameObjects = VmAutomationObjectSearch.Find<Transform>().Length;
