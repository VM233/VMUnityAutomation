...
namespace VMUnityAutomation.Editor
{
    internal sealed class VmProjectToolDescriptor
    {
        ...
        public VmAutomationTransactionProfile Transaction;
        ...
        public static VmProjectToolDescriptor FromMethod(VmProjectToolAttribute attribute, MethodInfo method)
        {
            ...
            var descriptor = new VmProjectToolDescriptor
            {
        ...
        public static VmProjectToolDescriptor FromType(VmProjectToolAttribute attribute, Type type)
        {
            string moduleId = VmProjectToolCatalogMetadata.ResolveModuleId(
        ...
        public Dictionary<string, object> ToSummaryDictionary()
        {
            ...
            VmAutomationContractMetadata.SetTags(summary, VmAutomationContractMetadata.BuildToolTags(
                readOnly: ReadOnly,
                dangerous: Dangerous,
            ...
            VmAutomationContractMetadata.AddOptionalList(summary, "sideEffects", GetSideEffectNames());
            VmAutomationContractMetadata.AddOptionalList(summary, "errorCodes", GetAdditionalErrorCodes());
            VmAutomationContractMetadata.AddOptionalList(summary, "aliases", Aliases);
            VmAutomationContractMetadata.AddOptionalList(summary, "searchTerms", SearchTerms);
            VmAutomationContractMetadata.AddOptionalList(summary, "preconditions", Preconditions);
            VmAutomationContractMetadata.AddOptionalString(summary, "whenToUse", WhenToUse);
            VmAutomationContractMetadata.AddOptionalString(summary, "notFor", NotFor);
            VmAutomationContractMetadata.AddOptionalString(summary, "completionEvidence", CompletionEvidence);
            VmAutomationContractMetadata.AddOptionalString(summary, "cleanupToolName", CleanupToolName);
            if (Transaction != null)
                summary["transaction"] = Transaction.ToDictionary();
            VmAutomationContractMetadata.AddOptionalString(summary, "validationError", ValidationError);
            return summary;
        }
        ...
        public Dictionary<string, object> ToDetailDictionary()
        {
            ...
            VmAutomationContractMetadata.AddOptionalString(descriptor, "shortName", ShortName);
            VmAutomationContractMetadata.AddOptionalString(descriptor, "source", Source);
            VmAutomationContractMetadata.SetTags(descriptor, VmAutomationContractMetadata.BuildToolTags(
                readOnly: ReadOnly,
                dangerous: Dangerous,
                longRunning: LongRunning,
                requiresPlayMode: RequiresPlayMode,
                ...
                outputSchema: EnforcesOutputSchema,
                invalid: string.IsNullOrEmpty(ValidationError) == false));
            VmAutomationContractMetadata.AddOptionalList(descriptor, "sideEffects", GetSideEffectNames());
            VmAutomationContractMetadata.AddOptionalList(descriptor, "errorCodes", GetAdditionalErrorCodes());
            VmAutomationContractMetadata.AddOptionalList(descriptor, "aliases", Aliases);
            VmAutomationContractMetadata.AddOptionalList(descriptor, "searchTerms", SearchTerms);
            VmAutomationContractMetadata.AddOptionalList(descriptor, "preconditions", Preconditions);
            VmAutomationContractMetadata.AddOptionalString(descriptor, "whenToUse", WhenToUse);
            VmAutomationContractMetadata.AddOptionalString(descriptor, "notFor", NotFor);
            VmAutomationContractMetadata.AddOptionalString(descriptor, "completionEvidence", CompletionEvidence);
            VmAutomationContractMetadata.AddOptionalString(descriptor, "cleanupToolName", CleanupToolName);
            if (Transaction != null)
                descriptor["transaction"] = Transaction.ToDictionary();
            VmAutomationContractMetadata.AddOptionalString(descriptor, "validationError", ValidationError);
            return descriptor;
        }
        ...
        public Dictionary<string, object> ToJobMetadata()
        {
            ...
            VmAutomationContractMetadata.AddOptionalList(metadata, "sideEffects", GetSideEffectNames());
            VmAutomationContractMetadata.AddOptionalString(metadata, "cleanupToolName", CleanupToolName);
            ...
            bool requiresPlayMode)
        {
            ...
            if (requiresPlayMode)
                result.Add(VmAutomationRuntimePreconditions.PlayModeRequiredErrorCode);
