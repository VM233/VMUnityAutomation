...
{
    internal static class MCPUssGeneratedChildStyleOwnershipAuditor
    {
            ...
            bool includeSuppressed)
        {
            ...
            foreach (var rule in rules)
            {
                foreach (var selector in rule.Selectors)
                {
                    ...
                    MCPUssStyleAuditor.AddIssue(report, rule, selector, token, KIND,
                        authored, runtime,
        ...
        internal static IReadOnlyList<Dictionary<string, object>> RunSelfTests()
        {
            ...
            var scopedRules = MCPUssStyleSheetParser.ParseStyleSheet(path,
            ...
            var variantRules = MCPUssStyleSheetParser.ParseStyleSheet(path,
