    ...
    public static class MCPBuildCommands
    {
        ...
        public static object GetBuildJob(Dictionary<string, object> args)
        {
            ...
            string owner = _job.Arguments != null && _job.Arguments.TryGetValue("_agentId", out object ownerValue)
                ? ownerValue?.ToString()
                : "anonymous";
            if (!MCPJobHistory.CanAccess(JobType, _job.JobId, owner, args))
        ...
        private static void SaveBuildJob()
        {
            ...
            string owner = _job.Arguments != null && _job.Arguments.TryGetValue("_agentId", out object value)
                ? value?.ToString()
                : "anonymous";
            MCPJobHistory.Record(JobType, _job.JobId, owner, _job.Status, BuildJobResponse(_job));
        }
        ...
        {
            MCPPersistenceFile.DeleteIfExists(GetBuildJobPath());
        }
