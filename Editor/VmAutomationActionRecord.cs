...
{
    /// <summary>
    /// Structured record of a single action performed by an agent via Automation.
    /// Captures timing, target objects, parameters, status, and undo group
    /// for display in the Action History UI.
    /// </summary>
    [Serializable]
    public class VmAutomationActionRecord
    {
        ...
        public string UndoStatus { get; set; } = "unavailable";
        public string UndoUnavailableReason { get; set; }
        ...
        /// Many Automation handlers return { instanceId, path, name } etc.
        /// </summary>
