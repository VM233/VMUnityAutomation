...
namespace VMUnityAutomation.Editor
{
    ...
    public static class MCPTestRunnerCommands
    {
        ...
        public static object RunTests(Dictionary<string, object> args)
        {
            ...
            MCPJobHistory.PublishAccessToken(response, JobType, job.JobId, job.AgentId);
            return response;
        }
        ...
        internal static object CancelTestJob(Dictionary<string, object> args)
        {
            ...
            if (!MCPJobHistory.CanAccess(JobType, job.JobId,
            ...
            bool includeFailedOnly, bool includeStackTrace, int offset, int limit, int failureLimit)
        {
            ...
            MCPJobHistory.PublishAccessToken(result, JobType, job.JobId, job.AgentId);
            return result;
        }
        ...
        private static void SaveToSessionState()
        {
            try
            {
                ...
                foreach (var job in _jobs.Values)
                    MCPJobHistory.Record(JobType, job.JobId, job.AgentId, job.Status.ToString(),
