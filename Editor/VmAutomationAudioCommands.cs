...
{
    public static class VmAutomationAudioCommands
    {
        public static object GetAudioInfo(Dictionary<string, object> args)
        {
            var sources = VmAutomationObjectSearch.Find<AudioSource>();
            ...
            foreach (var src in sources)
            {
                sourceList.Add(new Dictionary<string, object>
                {
                    ...
                    { "instanceId", VmObjectId.Get(src.gameObject) },
            ...
            var listeners = VmAutomationObjectSearch.Find<AudioListener>();
